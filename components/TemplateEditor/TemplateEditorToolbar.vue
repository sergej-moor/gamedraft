  ...
  <div class="min-w-full">
    <ul class="flex rounded-box bg-gray-400 rounded-r rounded-b p-1 min-w-full">
      <li v-tooltip="'New Text Attribute'">
        <button class="btn" @click="addTextAttribute()">
          <svg
      ...
      <li v-tooltip="'New Number Attribute'">
        <button class="btn" @click="addNumberAttribute()">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <li v-tooltip="'New Checkbox Attribute'">
        <button class="btn" @click="addCheckboxAttribute()">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <li v-tooltip="'New Image Attribute'">
        <button class="btn" @click="addImageAttribute()">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
